...
public class ProjecteSalut {
	...
	public static void main(String[] args) {
		...
		boolean isError = false; // variable per fer seguiment de l'error
		...
		if (!isError) {
			...
			isError = numSimptoma < MIN_SIMPTOMA || numSimptoma > MAX_SIMPTOMA;
		}
		...
		if (isError) {
			...
			System.out.printf("%-8s %-25s %-35s %-15s %-10s", "TIS", "Símptoma",
					"Exploració", "Nivell prioritat", "Temperatura actual\n");
