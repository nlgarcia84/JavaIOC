...
public class ProjecteSalut2 {
	...
	public static void main(String[] args) {
		...
		TIS = entrada.nextInt();
		while (TIS < 100000 || TIS > 999999) {
			System.out.println("Número de TIS incorrecte");
			TIS = entrada.nextInt();
			entrada.nextLine();
		}
		...
		while (numSimptoma < 0 || numSimptoma > 3) {
			System.out.println(
					"Opció incorrecte, introdueixi una opció del 0 al 3");
			numSimptoma = entrada.nextInt();
			entrada.nextLine();
		}
		...
		switch (numSimptoma) {
			...
			case 0 :
				...
				while (numExploracio < 0 || numExploracio > 3) {
					System.out.println(
							"Opció incorrecte, introdueixi una opció del 0 al 3");
					numExploracio = entrada.nextInt();
					entrada.nextLine();
		...
		while (nivellPrioritat < 0 || nivellPrioritat > 5) {
			System.out.println("Introdueixi un número entre 0 i 5");
			nivellPrioritat = entrada.nextInt();
			entrada.nextLine();
		}
		...
		while (temperaturaActual < 27 || temperaturaActual > 45) {
			System.out.println("Introdueixi un número entre 27 i 45");
			temperaturaActual = entrada.nextInt();
			entrada.nextLine();
		}

		System.out.print("TIS\n" + TIS);
		System.out.print("Símptoma\n" + simptoma);
